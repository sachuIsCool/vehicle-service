...
<div class="container-fluid">
    ...
    <div class="col-12">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <label for="status" class="control-label">Charges</label>
                    <select name="status" id="status" class="custom-select custom-select-sm rounded-0" required>
                        <option value="0" <?php echo isset($status) && $status == 0 ? "selected" : '' ?>>320/-rs</option>
                        <option value="1" <?php echo isset($status) && $status == 1 ? "selected" : '' ?>>3000/-rs</option>
                        <option value="2" <?php echo isset($status) && $status == 2 ? "selected" : '' ?>>6000/-rs</option>
                        <option value="3" <?php echo isset($status) && $status == 3 ? "selected" : '' ?>>3320/-rs</option>
