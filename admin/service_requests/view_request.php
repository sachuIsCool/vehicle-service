    ...
    <div class="row">
        <div class="col-sm-6">
            <dl>
                ...
                <dd class="pl-2">
                    <?php if($status == 0): ?>
                        <span class="badge badge-primary">Change oil (320/-rs)</span>
                    <?php elseif($status == 1): ?>
                        <span class="badge badge-warning">Engine Tune up (3000/-rs)</span>
                    <?php elseif($status == 2): ?>
                        <span class="badge badge-success">Overall Checkup (6000/-rs)</span>
                    <?php elseif($status == 3): ?>
                        <span class="badge badge-danger">Change oil & Engine Tune Up (3320/-rs)</span>
                    <?php else: ?>
