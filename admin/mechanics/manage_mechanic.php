...
<div class="card card-outline card-info">
	...
	<div class="card-body">
		<form action="" id="mechanic-form">
            ...
            <div class="form-group">
				<label for="status" class="control-label">Labour Per Day Charge</label>
                <select name="status" id="status" class="custom-select selevt">
                <option value="1" <?php echo isset($status) && $status == 1 ? 'selected' : '' ?>>800/-rs</option>
                <option value="0" <?php echo isset($status) && $status == 0 ? 'selected' : '' ?>>600/-rs</option>
				<option value="1" <?php echo isset($status) && $status == 2 ? 'selected' : '' ?>>600/-rs</option>
                </select>
			</div>
		</form>
	</div>
