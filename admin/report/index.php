                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
								<?php if($row['status'] == 0): ?>
									<span class="badge badge-primary"> pagal(320/-rs)</span>
								<?php elseif($row['status'] == 1): ?>
									<span class="badge badge-warning">(3000/-rs)</span>
								<?php elseif($row['status'] == 2): ?>
									<span class="badge badge-success">(6000/-rs)</span>
								<?php elseif($row['status'] == 3): ?>
									<span class="badge badge-danger">(3320/-rs)</span>
